...
async def get_weather(coords: dict[str, int], time: str, units: str) -> dict | None: # units = единица измерения температуры. metric = цельсии, imperial = фаренгеит, standard = калвины
